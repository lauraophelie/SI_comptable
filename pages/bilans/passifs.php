...
<div class="bilan-box-content">
    <table>
        ...
        <tr class="passif-line">
            <td> Capital émis </td>
            <td> 10100 </td>
            <td> <?php echo number_format($capitaux_propres["capital"], 0, ' ', ' '); ?> </td>
        </tr>
        <tr class="passif-line">
            <td> Réserves légales </td>
            <td> 10500 </td>
            <td> <?php echo number_format($capitaux_propres["reserves_legales"], 0, ' ', ' '); ?> </td>
        </tr>
        <tr class="passif-line">
            <td> Résultat en instance d'affectation </td>
            <td> 12800 </td>
            <td> <?php echo number_format($capitaux_propres["resultat_instance"], 0, ' ', ' '); ?> </td>
        </tr>
        <tr class="passif-line">
            <td> Résultat net </td>
            <td> 12000 </td>
            <td> <?php echo number_format($capitaux_propres["resultat"], 0, ' ', ' '); ?> </td>
        </tr>
        <tr class="passif-line">
            <td> Autres capitaux propres </td>
            <td> 11000 </td>
            <td> <?php echo number_format($capitaux_propres["autres_capitaux"], 0, ' ', ' '); ?> </td>
        </tr>
        <tr class="passif-line total-line">
            ...
            <th> </th>
            <th> <?php echo number_format(somme_valeurs($capitaux_propres), 0, ' ', ' '); ?> </th>
        </tr>
        <tr class="passif-line">
            <th colspan="4"> 
        ...
        <tr class="passif-line">
            ...
            <td> 13000 </td>
            <td> <?php echo number_format($passifs_non_courants["impots_differes"], 0, ' ', ' '); ?> </td>
        </tr>
        <tr class="passif-line">
        ...
        <tr class="passif-line total-line">
            ...
            <th> </th>
            <th> <?php echo number_format(somme_valeurs($passifs_non_courants), 0, ' ', ' '); ?> </th>
        </tr>
        <tr class="passif-line">
            <th colspan="4"> 
        ...
        <tr class="passif-line">
            ...
            <td> 16500 </td>
            <td> <?php echo number_format($passifs_courants["dettes_court_termes"], 0, ' ', ' '); ?> </td>
        </tr>
        <tr class="passif-line">
            <td> Fournisseurs et comptes rattachés </td>
            <td> 40000 </td>
            <td> <?php echo number_format($passifs_courants["fournisseurs"], 0, ' ', ' '); ?> </td>
        </tr>
        <tr class="passif-line">
        ...
        <tr class="passif-line">
            <td> Autres dettes </td>
            <td> 40000 </td>
            <td> <?php echo number_format($passifs_courants["autres_dettes"], 0, ' ', ' '); ?> </td>
        </tr>
        <tr class="passif-line">
            <td> Comptes de trésoreries </td>
            <td> 50000 </td>
            <td> <?php echo number_format($passifs_courants["tresorerie"], 0, ' ', ' '); ?> </td>
        </tr>
        <tr class="passif-line total-line">
            <th> 
            ...
            <th> </th>
            <th> <?php echo number_format(somme_valeurs($passifs_courants), 0, ' ', ' '); ?> </th>
        </tr>
        <tr class="passif-line total-line">
            <th> 
            ...
            <th> </th>
            <th> <?php echo number_format($somme_totale, 0, ' ', ' '); ?> </th>
        </tr>
    </table>
</div>