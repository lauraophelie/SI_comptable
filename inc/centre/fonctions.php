<?php
    ...
    function save($designation) {
        try{
            ...
            $sql="INSERT INTO centre(designation) values (:designation)";
    ...
    function verifcentre($designation){
        $connexion = db_connect();
        $sql="SELECT designation from centre where designation = :designation";
        $stmt = $connexion->prepare($sql);
        $stmt->bindParam(':designation',$designation);
        $stmt->execute();
    ...
    function update($id,$designation){
        try{
            ...
            $sql = "UPDATE centre SET designation = :designation where id=:id";
